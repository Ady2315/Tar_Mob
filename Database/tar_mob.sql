...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2023 at 01:05 PM
...
(23, 'Irimus Andrei', 'Str. Haiducilor, nr. 12, bl. 4A, ap. 10', 'Teius', 'Alba', '0756386295'),
(24, 'Andrei Irimus', 'Str. Haiducilor, nr. 12, bl. 4A, ap. 10', 'Teius', 'Alba', '0756386295'),
(25, 'Adi Irimus', 'Str Cucului, nr 34', 'Cluj Napoca', 'Cluj', '076674684'),
(26, 'Adi Irimus', 'Str Cucului, nr 34', 'Cluj Napoca', 'Cluj', '0748645363');
...
(12, 23, '2023-05-29', 'In curs de procesare'),
(13, 24, '2023-05-29', 'In tranzit'),
(14, 25, '2023-05-29', 'Spre destinatie'),
(15, 18, '2023-05-29', 'Spre destinatie');
...
(12, 'andrei_irimus2', 'Andrei Irimus', 0x243279243130247848735a54494b56492e742e576e526b367264694875753838474648643542715033576a59315a3572382e466d4674444249376343, 'andrei@irimus.ro');
...
--
ALTER TABLE `clienti`
  MODIFY `id_client` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `utilizator`
  MODIFY `id_utilizator` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
